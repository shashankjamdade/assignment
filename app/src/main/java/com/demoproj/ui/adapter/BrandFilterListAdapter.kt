...
import com.mvvmwithhilt.module.dto.BrandNameListItem
...
class BrandFilterListAdapter(
    var context: Context?,
    val listener: OnItemClickListener,
    var mList: ArrayList<BrandNameListItem>
) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        holder?.itemView?.chk_filter_item?.text = "${mList?.get(position)?.brandName}"
