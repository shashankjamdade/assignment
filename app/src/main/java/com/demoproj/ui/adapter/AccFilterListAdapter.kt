...
import com.mvvmwithhilt.module.dto.HierarchyItem
...
class AccFilterListAdapter(
    var context: Context?,
    val listener: OnItemClickListener,
    var mList: ArrayList<HierarchyItem>
) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        holder?.itemView?.chk_filter_item?.text = "${mList?.get(position)?.accountNumber}"
